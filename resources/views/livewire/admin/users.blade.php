                                                 ...
                                                 <td>
                                                     @if($product && $product->id==$i->id)
                                                         <select class="form-select" wire:model="title">
                                                             ...
                                                             <option value="کارت ویزیت هوشمند (معمولی)">کارت ویزیت هوشمند (معمولی)</option>
                                                             <option value="کارت ویزیت هوشمند (اختصاصی)">کارت ویزیت هوشمند (اختصاصی)</option>
                                                             <option value="تگ هوشمند (معمولی)">تگ هوشمند (معمولی)</option>
                                                             <option value="تگ هوشمند (اختصاصی)">تگ هوشمند (اختصاصی)</option>
                                                             <option value="استند هوشمند(a4)(اختصاصی)">استند هوشمند(a4)(اختصاصی)</option>
                                                             <option value="استند هوشمند(a5)(اختصاصی)">استند هوشمند(a5)(اختصاصی)</option>
                                                             <option value="استند هوشمند(a6)(اختصاصی)">استند هوشمند(a6)(اختصاصی)</option>
                                                             <option value="استند هوشمند(a4)(معمولی)">استند هوشمند(a4)(معمولی)</option>
                                                             <option value="استند هوشمند(a5)(معمولی)">استند هوشمند(a5)(معمولی)</option>
                                                             <option value="استند هوشمند(a6)(معمولی)">استند هوشمند(a6)(معمولی)</option>
                                                             <option value="منوی دیجیتال تک صفحه ای">منوی دیجیتال تک صفحه ای</option>
                                                             <option value="منوی دیجیتال چند صفحه ای">منوی دیجیتال چند صفحه ای</option>
