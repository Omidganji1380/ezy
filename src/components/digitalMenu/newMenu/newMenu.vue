    ...
    <div :class="{'d-none':step!==0}"
      ...
      <div class="row flex-nowrap justify-center mt-[40px] mx-auto">
        <input
            ...
            class="lowercase col-auto text-left w-full h-[44px] border-solid border-1 border-[#009606] focus-visible:outline-0 leading-10 rounded-[16px] bg-sec-color text-d8">
      </div>
      <div
        ...
        <p :class="{'opacity-0':nextButton}" class="text-center text-d8 pt-1">نام کاربری <span class="text-danger">تکراری</span>
