      ...
      <div class="section mt-3 mb-3">
        ...
        <div class="" name="inputs">
          <input type="text" @keydown.prevent="handleInputPhoneNumber($event)" v-model="data.phone" dir="ltr"
                 ...
                 class="w-100 text-[20px] font-shabnam-fd px-0 !pl-[135px] h-[56px] border-solid border-2 border-pri-color focus-visible:outline-0 rounded-[20px] bg-sec-color text-pri-color">
